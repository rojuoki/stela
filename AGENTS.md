...
## When to Read What (Lazy Load)

**Do not** read SOUL.md / USER.md / memory files / MEMORY.md at session start. Read **only when the current task needs them**.

- **Task first** — understand what you're doing, then pick files. Don't read everything "just in case."
...
- **No always-on load** — nothing is required at startup.
- **Large files** — skim or excerpt key points; don't paste full contents into chat.
