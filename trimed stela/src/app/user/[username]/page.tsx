            ...
            {accountData.protected ? (
              ...
              <>
                <div className="flex items-center gap-3 mb-2">
                  <button className="inline-flex items-center justify-center gap-2 bg-white text-black font-semibold px-6 py-3 rounded-lg hover:bg-zinc-200 transition-colors">
                    Subscribe
                  </button>
                  <button
                    onClick={() => handleExcavate(false)}
