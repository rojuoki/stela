...
export default function CreditPurchasePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="py-2 px-4 rounded-lg font-medium bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      <div className="mb-8">
        <div className="bg-zinc-900/30 border border-zinc-800/30 rounded-lg p-4 hover:border-zinc-700/30 transition-colors">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="text-zinc-400 font-medium">[{PREMIUM_PACKAGE.credits}credit]</div>
              <div className="text-zinc-500 text-sm">{PREMIUM_PACKAGE.label}</div>
            </div>
            
            <div className="text-zinc-300 font-semibold">${PREMIUM_PACKAGE.price}</div>
            
            <button
              onClick={() => handlePurchase(PREMIUM_PACKAGE.credits)}
              disabled={purchasing === PREMIUM_PACKAGE.credits}
              className="bg-zinc-800/50 hover:bg-zinc-700/50 text-zinc-300 border border-zinc-700/50 py-1 px-3 rounded text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
