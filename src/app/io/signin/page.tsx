...
export default function IoSignInPage() {
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-16">
      <Link href="/io" className="text-sm text-zinc-400 hover:text-white">← 検索に戻る</Link>
      ...
      <form onSubmit={submit} className="mt-5 space-y-4">
        ...
        {mode === "signup" && <label className="block text-sm">パスワード（確認）
        ...
        {mode === "signup" && <p className="text-xs leading-relaxed text-zinc-500">8文字以上。メール確認とパスワード再設定は、販売開始前に追加します。</p>}
